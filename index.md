...
- [配置文件详解](./docs/advanced/configuration)
- [多 Agent 路由](./docs/advanced/multi-agent)
- [Skills 技能系统](./docs/advanced/skills)
- [移动端 Nodes](./docs/advanced/nodes)
- [定时任务 Cron](./docs/advanced/cron)
- [Sub-Agents](./docs/advanced/sub-agents)
- [浏览器工具](./docs/advanced/browser)
- [安全配置](./docs/advanced/security)
...
| 方式 | 适合人群 | 难度 |
|------|----------|------|
| [快速安装](./docs/quick-start#快速安装) | 新手推荐 | ⭐ |
| [NPM 安装](./docs/quick-start#npm-安装) | 开发者 | ⭐⭐ |
| [Docker 部署](./docs/quick-start#docker-部署) | 运维人员 | ⭐⭐⭐ |
